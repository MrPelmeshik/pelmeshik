...
export const MenuItems: IMenuItem[] = [
    ...
    },
    {
        ...
        element: <TableComponent key={CatalogTypeEnum.TRANSACTION_FREQUENCY}
                                 ...
                                 tableSrcCfg={TransactionFrequencySrcCfg}
